    ...
    return (
        <View className="flex-1 bg-background px-2 justify-between py-10">
            <View className="gap-4 overflow-hidden">
                ...
                <View className="w-full justify-center h-[80%] gap-4">
                    ...
                    <View className='h-[60%] items-center justify-center'>
                        ...
                        <Text className='font-regular text-md text-black absolute bg-background top-4 z-30'>Effective{"\n"}Exercise</Text>
                        <Text className='font-regular text-md text-black absolute bg-background left-0 bottom-5 text-center z-30'>Mindful{"\n"}Diet</Text> 
                        <Text className='font-regular text-md text-black absolute bg-background right-0 bottom-5 text-center z-30'>Guided{"\n"}Relaxation</Text>  
                    </View>
            ...
            <View className='w-full px-4 flex-row justify-center gap-4'>
                ...
                <NavButton title="Continue" to="/(onboarding)/userDetails3" width="half" rounded="full" />
            </View>
        </View>
    );
}
...
export default function UserFeature7() {
    return (
        <View className="flex-1 bg-background justify-between py-10">
            <View className="gap-2 bg-white">
                <View className="pt-6 w-[100%] h-[20%] px-6 flex-row items-center">
                    <Text className="font-semibold flex-1 flex-wrap text-black text-left text-xl">Workout with Camara <Text className="text-primary">Groups</Text></Text>
                    <ExerciseDolls height="45%" width="50%" />
                </View>
                <View className="w-full px-6 h-[68%] justify-center gap-4">
                <LinearGradient colors={["transparent", "rgba(0,0,0,0.15)"]} style={{position: 'absolute', top: -4, left: 0, right: 0, height: 4, zIndex: 1}} />
                    ...
                    <View className='items-center mt-4'>
                        ...
                        <Text className="font-semibold text-black text-center text-sm">2-camera preview: split screen (You + 1 partner).

...
export default function ClassScreen() {
    ...
    return (
                ...
                <View className='border rounded-md border-[#E5E5E5]'>
                    ...
                    <View className='mx-4 gap-4 mt-8'>
                        ...
                        <View className='justify-between items-center flex-row'>
                            ...
                            <Pressable onPress={() => setOpen(!open)} className='border relative border-[#E5E5E5] w-[30%] px-2 py-2 flex-row justify-between rounded-sm items-center'>
            ...
            {open && (
                <View className='absolute top-12 bg-white border border-[#E5E5E5] rounded-md w-[100%] z-100'>
                    <Pressable onPress={() => {
                        setData("Low");
                        setOpen(false);
                    ...
                    <View className='px-4 my-4 z-10'>
                        <NavButton  title='Start Class'/>
                    </View>
                </View>
                </View>
            </View>

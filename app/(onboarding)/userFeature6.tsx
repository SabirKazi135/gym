...
export default function UserFeature6() {
    return (
        <View className="flex-1 bg-background justify-between py-10">
            <View className="gap-6 bg-white">
                <View className="pt-12 w-[100%] h-[15%] px-6 overflow-x-scroll flex-row items-center">
                    {/* <View className='w-[40%]'> */}
                    <Text className="font-semibold flex-1 flex-wrap text-left text-xl">Never Train <Text className="text-primary">Alone</Text></Text>
                    {/* </View> */}
                    {/* <View className='w-[60%]'> */}
                ...
                <LinearGradient colors={["transparent", "rgba(0,0,0,0.15)"]} style={{position: 'absolute', top: -4, left: 0, right: 0, height: 4, zIndex: 1}} />
                    <View className='w-full mt-6 items-center h-[50%]'>
                        {/* <UserFeatureImage imageUrl={image} /> */}
                        <GroupCard members="two" text="Paired View (1 members) with companion"/>
                    </View>
                    <View className='items-center gap-3'>
                        <Text className="font-semibold text-center text-primary text-md">Join sessions with a workout companion</Text>
                        <Text className="font-light text-center text-md">When you work out solo, a blurred companion appears, keeping your session energetic, engaging, and as lively as group training.</Text>
                    </View>
            ...
            <View className='w-full px-6 flex-row justify-center gap-4'>
                ...
                <NavButton title="Continue" to="/(onboarding)/userFeature7" width="half" rounded="full" />
            </View>
        </View>
    );
}